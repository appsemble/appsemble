...
This enables encrypted transport on the database path. When PgBouncer is enabled, Appsemble connects
to PgBouncer over TLS and PgBouncer connects to PostgreSQL over TLS. The `secure` protocol shortcut
