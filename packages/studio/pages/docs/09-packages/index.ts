...
export function applyPackages<T>(documents: T[]): void {
  for (const doc of [
    { Component: Cli, path: '09-packages/cli', title: '@appsemble/cli' },
    { Component: Preact, path: '09-packages/preact', title: '@appsemble/preact' },
    { Component: Sdk, path: '09-packages/sdk', title: '@appsemble/sdk' },
    {
      Component: WebpackConfig,
      path: '09-packages/webpack-config',
      title: '@appsemble/webpack-config',
    },
    { Component: CreateAppsemble, path: '09-packages/create-appsemble', title: 'create-appsemble' },
  ]) {
    documents.push({
      ...doc,
      searchIndex: [],
