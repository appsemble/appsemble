...
Resource actions can be used in association with [groups](../02-guides/groups.md) to limit CRUD
...
resources to the members of group and creating resource to the manager.
