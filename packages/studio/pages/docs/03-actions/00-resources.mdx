...
Resource actions can be used in association with [teams](../guides/teams.md) to limit CRUD actions
on your resources. This can be particularly helpful in separating roles and privileges of various
users in your organization. Following is an example of how you can limit querying `employee`
