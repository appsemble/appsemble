...
import { linkActions as actions } from '../../../../utils/reference-schemas/actions/link.ts';
...
<ActionRef action={actions['link.back']} />
...
<ActionRef action={actions['link.next']} />
