...
import { miscellaneousActions as actions } from '../../../../utils/reference-schemas/actions/miscellaneous.ts';
...
<ActionRef action={actions['analytics']} />
...
<ActionRef action={actions['condition']} />
...
<ActionRef action={actions['controller']} />
...
<ActionRef action={actions['download']} />
...
<ActionRef action={actions['dialog']} />
...
<ActionRef action={actions['dialog.ok']} />
...
<ActionRef action={actions['dialog.error']} />
...
<ActionRef action={actions['event']} />
...
<ActionRef action={actions['email']} />
...
<ActionRef action={actions['match']} />
...
<ActionRef action={actions['message']} />
...
<ActionRef action={actions['notify']} />
...
<ActionRef action={actions['request']} />
...
<ActionRef action={actions['share']} />
...
<ActionRef action={actions['static']} />
...
<ActionRef action={actions['throw']} />
