...
the context. For more information check out [security](../app/security.md#permissions). Here’s an
example of how you can use this action to fetch the number of resources.
...
create a new resource of type person.
...
you can partially update a resource of type person using this action.
