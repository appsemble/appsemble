...
- [`user.register`](/docs/reference/action#user.register)
- [`user.login`](/docs/reference/action#user.login)
- [`user.update`](/docs/reference/action#user.update)
- [`user.logout`](/docs/reference/action#user.logout)
- [`user.query`](/docs/reference/action#user.query)
- [`user.remove`](/docs/reference/action#user.remove)
- [`user.create`](/docs/reference/action#user.create)
