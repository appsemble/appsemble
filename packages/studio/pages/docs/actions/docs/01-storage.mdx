...
- [`storage.read`](/docs/reference/action#storage.read)
- [`storage.write`](/docs/reference/action#storage.write)
- [`storage.append`](/docs/reference/action#storage.append)
- [`storage.subtract`](/docs/reference/action#storage.subtract)
- [`storage.update`](/docs/reference/action#storage.update)
- [`storage.delete`](/docs/reference/action#storage.delete)
