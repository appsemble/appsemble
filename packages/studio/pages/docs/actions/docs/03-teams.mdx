...
This action allows to get a list of all of the teams user is a part of. Supported field for this
action is `type`, which is `team.list` in this case. This action can be helpful in keeping a record
of various organizational roles assigned to a user. Here is an example of how you can use this
action to list all teams of a user.
