...
- [`resource.get`](/docs/reference/action#resource.get)
- [`resource.query`](/docs/reference/action#resource.query)
- [`resource.count`](/docs/reference/action#resource.count)
- [`resource.create`](/docs/reference/action#resource.create)
- [`resource.update`](/docs/reference/action#resource.update)
- [`resource.patch`](/docs/reference/action#resource.patch)
- [`resource.delete`](/docs/reference/action#resource.delete)
- [`resource.subscription.subscribe`](/docs/reference/action#resource.subscription.subscribe)
- [`resource.subscription.unsubscribe`](/docs/reference/action#resource.subscription.unsubscribe)
- [`resource.subscription.toggle`](/docs/reference/action#resource.subscription.toggle)
- [`resource.subscription.status`](/docs/reference/action#resource.subscription.status)
