...
[`translate`](../07-remappers/04-data.mdx#translate) or
[`string.format`](../07-remappers/00-strings.mdx#stringformat) remappers. The former is typically
...
[if remapper](../07-remappers/06-conditionals.mdx#if).
