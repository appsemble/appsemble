import { serverActions } from '@appsemble/utils/serverActions';

# Cron Jobs

Appsemble provides a way to run [actions](/docs/reference/action) based on a schedule through cron
jobs.
...
> minutes. This means that running the job at e.g. 14:01 will not run it at 14:01, but at 14:05.
...
[user](/docs/reference/remapper#user) remapper won't work the same.
...
[cron](/docs/reference/app#-app-definition-cron) property.
