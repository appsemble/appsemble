...
can run the following command to login into the [Appsemble CLI](/docs/09-packages/cli).
...
[action](../06-actions/index.mdx), adding a new [remapper](../07-remappers/index.mdx), adding new
