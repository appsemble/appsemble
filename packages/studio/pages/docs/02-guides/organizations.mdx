...
An organization represents a collective name for groups of apps, blocks and Appsemble users. In
order to publish new blocks or to create and manage apps, the user needs to be in an organization.
