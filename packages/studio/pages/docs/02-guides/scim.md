...
1. Firstly, to configure your Appsemble application so that individual users can log in, your app
   ...
   [security definition](../guides/security.md#security-definition).

   **(Optional)** If your application wants to use the [Teams](../guides/teams.md) functionality,
   this security definition also has to contain a [teams definition](../guides/security.md#teams).
