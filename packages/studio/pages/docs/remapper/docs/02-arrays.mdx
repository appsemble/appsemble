...
In the [Objects](/docs/remapper/objects) page, we explained how to manipulate an object so it only
...
[if condition](/docs/remapper/conditions). With this data, you could check if the employee’s age is
