...
Cron jobs that contain resource or member actions need security permissions. In the security
definition add the appropriate permissions under the cron property.
