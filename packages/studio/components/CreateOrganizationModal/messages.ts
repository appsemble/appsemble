...
export const messages = defineMessages({
  ...
  organizationIdDescription: {
    id: 'studio.VRUpmK',
    defaultMessage: 'A unique identifier for the organization.',
  },
  organizationName: {
    id: 'studio.NdO+zh',
  ...
  conflict: {
    id: 'studio.p05LGD',
    defaultMessage: 'An organization with the given ID already exists',
  },
  error: {
    id: 'studio.sa1orx',
    defaultMessage: 'There was a problem creating the organization.',
  },
  logo: {
    id: 'studio.k81S1y',
    defaultMessage: 'Logo',
