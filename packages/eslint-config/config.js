...
import { preact, react, web } from './configs/index.js';
...
export default defineConfig([
  ...
  },
  {
    ...
    rules: {
      'formatjs/enforce-id': [
        'error',
        { idInterpolationPattern: 'app.[sha512:contenthash:base64:6]' },
      ],
  ...
  },
  {
    ...
    rules: {
      'n/no-published-import': 'off',
      'formatjs/enforce-id': [
        'error',
        { idInterpolationPattern: 'react-components.[sha512:contenthash:base64:6]' },
      ],
      'react/prop-types': 'off',
      'react/require-default-props': 'off',
    },
