  ...
  allOf: [
    ...
    },
    {
      anyOf: [
        ...
        { $ref: '#/components/schemas/GroupInviteActionDefinition' },
        { $ref: '#/components/schemas/GroupJoinActionDefinition' },
        { $ref: '#/components/schemas/GroupListActionDefinition' },
        { $ref: '#/components/schemas/GroupMembersActionDefinition' },
        ...
        { $ref: '#/components/schemas/AppMemberUpdateActionDefinition' },
        { $ref: '#/components/schemas/AppMemberQueryActionDefinition' },
        { $ref: '#/components/schemas/AppMemberRemoveActionDefinition' },
      ],
    },
  ],
};
