...
describe('generateBlockData', () => {
  ...
  it('should throw if duplicate Actions are found', () => {
    expect(() => generateBlockData({}, fixture('duplicateActions'))).toThrow(
      new AppsembleError(
        "Found duplicate interface 'Actions' in 'packages/cli/lib/__fixtures__/generateBlockData/duplicateActions/index.ts:31'",
      ),
    );
  });
  ...
  it('should throw if duplicate EventEmitters are found', () => {
    expect(() => generateBlockData({}, fixture('duplicateEventEmitters'))).toThrow(
      new AppsembleError(
        "Found duplicate interface 'EventEmitters' in 'packages/cli/lib/__fixtures__/generateBlockData/duplicateEventEmitters/index.ts:31'",
      ),
    );
  });
  ...
  it('should throw if duplicate EventListeners are found', () => {
    expect(() => generateBlockData({}, fixture('duplicateEventListeners'))).toThrow(
      new AppsembleError(
        "Found duplicate interface 'EventListeners' in 'packages/cli/lib/__fixtures__/generateBlockData/duplicateEventListeners/index.ts:31'",
      ),
    );
  });
  ...
  it('should throw if duplicate Parameters are found', () => {
    expect(() => generateBlockData({}, fixture('duplicateParameters'))).toThrow(
      new AppsembleError(
        "Found duplicate interface 'Parameters' in 'packages/cli/lib/__fixtures__/generateBlockData/duplicateParameters/index.ts:31'",
      ),
    );
  });
