          ...
          "errors": [
            {
              ...
              "property": "instance.pages.test-page.blocks[0].type",
              "stack": "instance.pages.test-page.blocks[0].type is not a known block type",
            },
          ],
        },
        "error": "Bad Request",
          ...
          "errors": [
            {
              ...
              "property": "instance.pages.test-page.blocks[0].parameters.foo",
              "stack": "instance.pages.test-page.blocks[0].parameters.foo is not of a type(s) number",
            },
          ],
        },
        "error": "Bad Request",
