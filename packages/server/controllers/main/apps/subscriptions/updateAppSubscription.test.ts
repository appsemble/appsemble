...
describe('updateAppSubscription', () => {
  it('should update resource type subscription settings', async () => {
    ...
    authorizeApp(app);
    const response = await request.patch(`/api/main/apps/${app.id}/subscriptions`, {
      endpoint: 'https://example.com',
      resource: 'person',
      action: 'create',
      value: true,
    ...
    const responseB = await request.get(`/api/main/apps/${app.id}/subscriptions`, {
  ...
  it('should remove individual resource subscription settings if set to false', async () => {
    ...
    const responseA = await request.get(`/api/main/apps/${app.id}/subscriptions`, {
      params: { endpoint: 'https://example.com' },
    });
