...
describe('deleteAppCoreStyle', () => {
  it('should delete coreStyle for an app', async () => {
    authorizeStudio();
    ...
    const response = await request.delete(`/api/apps/${app.id}/style/core`);
    expect(response.status).toBe(204);
  ...
  it('should return 404 for an app that does not exist', async () => {
    ...
    const response = await request.delete('/api/apps/0/style/core');
    expect(response).toMatchInlineSnapshot(`
      HTTP/1.1 404 Not Found
      Content-Type: application/json; charset=utf-8
  ...
  it('should return 404 if coreStyle for an app does not exist', async () => {
    authorizeStudio();
    ...
    expect(response).toMatchInlineSnapshot(`
      ...
      {
        "error": "Not Found",
        "message": "App core style not found",
        "statusCode": 404,
      }
    `);
  });
...
describe('getAppCoreStyle', () => {
  it('should fetch sharedStyle for an app', async () => {
    ...
    const response = await request.get(`/api/apps/${app.id}/style/core`);
    expect(response.status).toBe(200);
    expect(response.data).toMatchInlineSnapshot(`
      "
              * {
  ...
  it('should return 404 for an app that does not exist', async () => {
    const response = await request.get('/api/apps/0/style/core');
    expect(response).toMatchInlineSnapshot(`
      HTTP/1.1 404 Not Found
      Content-Type: application/json; charset=utf-8
